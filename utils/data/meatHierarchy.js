...
//
// Order reversed in v0.0.65, and it is the order the CARD shows and the
// first entry is what it opens on. Untrimmed first because that is what a
// cut looks like when you buy it -- a ribeye has fat on it, and opening
// every steak on its leanest possible version made the pictures in the Cuts
// list read as trimmed medallions rather than steaks. Trimming is what you
// do to a cut, so it belongs after the cut itself, not before it.
